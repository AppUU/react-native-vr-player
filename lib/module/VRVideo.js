...
import VRFilterType from './VRFilterType';
const styles = StyleSheet.create({
  base: {
    overflow: 'hidden'
  }
});
export { TextTrackType, FilterType, DRMType, VRFilterType };
export default class VRVideo extends Component {
  ...
  render() {
    ...
    const posterStyle = { ...StyleSheet.absoluteFillObject,
      resizeMode: this.props.posterResizeMode || 'contain'
    };
    return /*#__PURE__*/React.createElement(View, {
      style: nativeProps.style
    }, /*#__PURE__*/React.createElement(RCTVRVideo, _extends({
      ref: this._assignRoot
    }, nativeProps, {
      style: StyleSheet.absoluteFill
    })), this.state.showPoster && /*#__PURE__*/React.createElement(Image, {
      style: posterStyle,
      source: {
...
VRVideo.propTypes = {
  /**android vr only */
  switchInteractiveMode: PropTypes.oneOf([VRFilterType.INTERACTIVE_MODE_CARDBORAD_MOTION, VRFilterType.INTERACTIVE_MODE_CARDBORAD_MOTION_WITH_TOUCH, VRFilterType.INTERACTIVE_MODE_TOUCH, VRFilterType.INTERACTIVE_MODE_MOTION, VRFilterType.INTERACTIVE_MODE_MOTION_WITH_TOUCH]),
  switchDisplayMode: PropTypes.oneOf([VRFilterType.DISPLAY_MODE_GLASS, VRFilterType.DISPLAY_MODE_NORMAL]),
  switchProjectionMode: PropTypes.oneOf([VRFilterType.PROJECTION_MODE_SPHERE, VRFilterType.PROJECTION_MODE_CUBE]),
...
const RCTVRVideo = requireNativeComponent('RCTVRVideo', VRVideo, {
  nativeOnly: {
    src: true,
    seek: true,
    fullscreen: true
